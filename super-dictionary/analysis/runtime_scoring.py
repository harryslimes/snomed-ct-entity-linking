...
def _aggregate_note(
    ...
    # Coordinate compression over all segment boundaries for this note. This preserves
    # the "last write wins" overwrite semantics of the original dense char-array fill,
    # without allocating arrays of length max_end.
    if gt_note is None:
    ...
    # Apply segments in row order to match dense-array overwrite semantics.
